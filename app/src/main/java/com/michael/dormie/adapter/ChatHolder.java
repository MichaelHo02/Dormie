...
import com.michael.dormie.model.AbstractChat;
...
public class ChatHolder extends RecyclerView.ViewHolder {
    ...
    public ChatHolder(@NonNull View itemView) {
        ...
        mGreen300 = ContextCompat.getColor(itemView.getContext(), androidx.cardview.R.color.cardview_light_background);
        mGray300 = ContextCompat.getColor(itemView.getContext(), androidx.cardview.R.color.cardview_dark_background);
    }
